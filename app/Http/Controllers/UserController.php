    ...
    public function register()
    {
        ...
        switch ($this->level){
            ...
            case 5:
                ...
                $user=(new user())->where('phone_number',$this->phone_number)->pluck('last_name')->first();

                $this->screen_response=
                    "<strong>Congratulations <i>$user</i></strong>,you have successfully registered on Bikebuka Online Classes\n";
